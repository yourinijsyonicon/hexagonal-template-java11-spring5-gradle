...
class GetCustomerQueryTest {
    ...
    class TestWhenFound {
        ...
        @BeforeEach
        void setup() {
            actual = query.getCustomer(expected.takeSnapshot().getId());
        }
        ...
        void itShouldGetCustomer() {
            ...
            assertThat(actual.getId()).isEqualTo(expected.takeSnapshot().getId());
            assertThat(actual.getDto()).isEqualTo(expected.takeSnapshot().getDto());
        }
    }
